...
class AppLoginCubit extends Cubit<AppLoginStates> {
  ...
  Future<void> selectPermission() async {
    FirebaseFirestore.instance
      ...
      permission_fire = snap.get('permission');
      emit(SelectPermission());
      CacheHelper.saveData(key: 'permission', value: permission_fire);
      emit(saveData());
    });
  }
  ...
  Future<void> getCode() async {
    FirebaseFirestore.instance
      ...
      code_fire = user['code'];
      emit(GetCode());
      CacheHelper.saveData(key: 'code', value: code_fire);
      emit(savePermission());
    });
  }
            ...
            snapshot.docs.forEach((f) {
              FirebaseFirestore.instance
                ...
                final headers = {
                  ...
                  'Authorization':
                      'key= AAAA4ciV6BI:APA91bFD_C_yBcTUJpPgwZcjbtP6LGk_kOXPNclh5PfCADmuRMk8GFw8hjwDfgD1-IE4CUXsPJPY9yc10_P2EeZbWfnkDSFIAI0p56FDOd1N57WJTgObdC5T8awzoDUy-KskB554PSlv',
                };
