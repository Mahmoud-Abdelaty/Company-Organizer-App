// ignore_for_file: use_key_in_widget_constructors, deprecated_member_use, prefer_const_constructors, avoid_print, must_be_immutable, sized_box_for_whitespace, unnecessary_string_interpolations, prefer_const_literals_to_create_immutables
                        ...
                        builder: (context) {
                          return Container(
                            ...
                            child: CupertinoAlertDialog(
                                        ...
                                        for (int t = 0;
                                          ...
                                          AppCubit.get(context).addBackUp(
                                              ...
                                              misionType: snapshot.data!.docs[t]
                                                  [KMisionTypeFire],
                                              reportController: snapshot.data!.docs[t][KReportFire]
                                                      .toString()
                                                      .isEmpty
                                                  ? snapshot.data!.docs[t][KFailedFire]
                              ...
                              actions: [
                                CupertinoDialogAction(
                                  child: Text(translator.translate('close')),
                                  onPressed: () {
                                    Navigator.pop(context);
                                  },
                                )
